...
import workshopGroup from "@/assets/gallery/workshop-group.jpg";
import roboticHand from "@/assets/gallery/robotic-hand.jpg";
import motorPropellerClass from "@/assets/gallery/motor-propeller-class.jpg";
import arduinoClass from "@/assets/gallery/arduino-class.jpg";
import droneDemo from "@/assets/gallery/drone-demo.jpg";
import outdoorFlight from "@/assets/gallery/outdoor-flight.jpg";
import mentoring from "@/assets/gallery/mentoring.jpg";
import handsOnAssembly from "@/assets/gallery/hands-on-assembly.jpg";
import awardCeremony from "@/assets/gallery/award-ceremony.jpg";
import fpvDemo from "@/assets/gallery/fpv-demo.jpg";
import fpvDroneController from "@/assets/gallery/fpv-drone-controller.jpg";
import quadcopterTopview from "@/assets/gallery/quadcopter-topview.jpg";
import cinewhoopDrone from "@/assets/gallery/cinewhoop-drone.jpg";
import droneElectronics from "@/assets/gallery/drone-electronics.jpg";

const categories = ["All", "Drones", "Components", "Training", "Labs", "Events"];
const galleryItems = [
  // Events - featured
  { src: fpvDemo, category: "Events", title: "FPV Goggles Demo", size: "large" },
  // Drones
  { src: quadcopterTopview, category: "Drones", title: "Quadcopter – Top View", size: "large" },
  { src: cinewhoopDrone, category: "Drones", title: "Cinewhoop FPV Drone", size: "medium" },
  { src: fpvDroneController, category: "Drones", title: "FPV Racer & Controller", size: "medium" },
  // Components
  { src: droneElectronics, category: "Components", title: "Flight Controller Wiring", size: "medium" },
  { src: roboticHand, category: "Labs", title: "Robotic Hand Project", size: "medium" },
  // Training
  { src: workshopGroup, category: "Training", title: "Drone Building Workshop", size: "large" },
  { src: motorPropellerClass, category: "Training", title: "Motor & Propeller Pairing", size: "small" },
  { src: arduinoClass, category: "Training", title: "Arduino & Drone Class", size: "medium" },
  { src: droneDemo, category: "Training", title: "Hands-on Drone Demo", size: "large" },
  { src: outdoorFlight, category: "Training", title: "Outdoor Flight Session", size: "medium" },
  { src: mentoring, category: "Training", title: "One-on-One Mentoring", size: "small" },
  { src: handsOnAssembly, category: "Training", title: "Drone Assembly Workshop", size: "medium" },
  // Events
  { src: awardCeremony, category: "Events", title: "Award Ceremony", size: "medium" },
];
